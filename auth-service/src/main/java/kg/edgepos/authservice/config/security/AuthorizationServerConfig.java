...
import kg.edgepos.authservice.config.security.granttype.password.OAuth2PasswordAuthenticationConverter;
import kg.edgepos.authservice.config.security.granttype.password.OAuth2PasswordTokenAuthenticationProvider;
import kg.edgepos.authservice.config.security.properties.AuthorizationServerProperties;
import kg.edgepos.authservice.service.security.IntrospectionService;
