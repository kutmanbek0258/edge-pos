...
import kg.edgepos.authservice.config.security.introspector.CustomSpringTokenIntrospection;
import kg.edgepos.authservice.config.security.properties.OAuth2ResourceOpaqueProperties;
