package kg.edgepos.authservice.config.security;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.DeserializationContext;
import com.fasterxml.jackson.databind.JsonDeserializer;
import jakarta.annotation.PostConstruct;
import kg.edgepos.authservice.config.filter.XSSFilter;
import kg.edgepos.authservice.config.security.handler.CustomAuthenticationSuccessHandler;
import kg.edgepos.authservice.config.security.handler.CustomOauthAuthenticationSuccessHandler;
import kg.edgepos.authservice.config.security.properties.AuthorizationServerProperties;
import kg.edgepos.authservice.service.UserEventService;
import kg.edgepos.authservice.service.impl.CustomOAuth2UserService;
import kg.edgepos.authservice.service.impl.CustomUserDetailsService;
import kg.edgepos.authservice.config.SecurityProperties;
