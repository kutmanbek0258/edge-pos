package kg.edgepos.apigateway.config.security.introspector;

import kg.edgepos.apigateway.dto.AuthorizedUser;
import kg.edgepos.apigateway.dto.TokenInfoDto;
