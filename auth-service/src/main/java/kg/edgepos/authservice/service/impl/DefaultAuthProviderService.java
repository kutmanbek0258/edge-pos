...
import kg.edgepos.authservice.dao.repository.RoleRepository;
...
import kg.edgepos.authservice.exception.AuthException;
import kg.edgepos.authservice.mapper.AuthorizedUserMapper;
import kg.edgepos.authservice.service.AuthProviderService;
import kg.edgepos.authservice.service.FileStoreService;
import kg.edgepos.authservice.type.AuthErrorCode;
