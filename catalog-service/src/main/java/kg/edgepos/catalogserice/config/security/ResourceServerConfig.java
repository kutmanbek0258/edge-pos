package kg.edgepos.catalogserice.config.security;

import kg.edgepos.catalogserice.config.security.introspector.CustomSpringTokenIntrospection;
...
public class ResourceServerConfig {
    ...
    @Bean
    @Order(1) // Second priority for other public paths
    ...
    @Bean
    @Order(2) // Last priority for all other authenticated endpoints
